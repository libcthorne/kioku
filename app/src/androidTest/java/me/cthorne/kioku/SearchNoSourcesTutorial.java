...
@LargeTest
public class SearchNoSourcesTutorial {
    ...
    public CleanBeforeIntentsTestRule<MainActivity> mActivityRule = new CleanBeforeIntentsTestRule<>(MainActivity.class, new CleanBeforeIntentsTestRule.PostCleanCallback() {
        ...
        public void run(Context context) {
            ...
            // In tutorial
            KiokuServerClient.getPreferences(context).edit().putBoolean("inTutorial", true).commit();
        }
    });
    ...
    public void search() {
        ...
        Checks.checkToastMessageNotDisplayed(mActivityRule.getActivity(), R.string.search_no_sources_error);
    }
