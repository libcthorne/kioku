...
public class AddLanguageJP {
    ...
    public void addLanguage() throws SQLException, InterruptedException {
        ...
        /*onData(anything()).inAdapterView(withId(R.id.languages_listview))
                          .atPosition(0)
                          .perform(click());*/

        // Select "Japanese"
        onData(hasToString(equalTo("Japanese")))
        ...
        assertTrue(dbHelper.getUserLanguages().contains(new SelectedWordLanguage(getTargetContext(), WordLanguage.JP)));
